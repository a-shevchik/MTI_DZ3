...
public class KPP {
	...
	public static void main(String[] args) {
		...
		for (PassengerVehicle ps : passcars){
			try {		
				ps.printcarinfo();//Информация об автомобиле
				System.out.println("Стоимость проезда: " + ps.calculatetarif() + " руб.");
			}
